<template><div><h1 id="advanced-parts2" tabindex="-1"><a class="header-anchor" href="#advanced-parts2"><span>Advanced parts2</span></a></h1>
<p>*Go to <a href="https://ca.pcpartpicker.com/" target="_blank" rel="noopener noreferrer">Part picker</a> for shopping and compatibility check. Not all parts are universal,
...
NAS component recommendations (This might differ for work rigs, gaming rigs, etc..):</p>
<ol>
<li>Power Supply (PSU):
...
◦ Personal choice: Seasonic FOCUS GX-850 80+ Gold <code v-pre>&lt;p&gt;This is a paragraph&lt;/p&gt;</code></li>
<li>CPU (Processor):
...
◦ Intel Core i5-8600k: Budget choice, will work well in a low traffic NAS server. With quick sync.</li>
<li>CPU Cooler:
...
what we want. Air coolers last longer with only basic maintenance.</li>
<li>RAM (Memory):
...
◦ Personal Choice: Corsair, or TeamGroup (Min. 32GB, 2x16, or 4x8)</li>
<li>Storage Drives (HDDs for NAS): You will need an identical sized parity drive (if your highest array drive is 8TB,
...
◦ 2x Seagate Compute 8TB: Reliable, not expensive, fast transfers (read/write), high life cycle.</li>
<li>Motherboard:
◦ MSI MAG B660 TOMAHAWK: Good for Intel builds (LGA1700, i5-13600k)
◦ ASUS ROG Strix B450-F: Good for AMD builds (AM4, Ryzen 7 3700x)</li>
<li>*OPTIONAL Graphics: *If you get a quick sync capable CPU then this component is unnecessary:
